...
var collision = tilemap_get_at_pixel(collision_map_id, bbox_left, bbox_top) ||
				tilemap_get_at_pixel(collision_map_id, bbox_right, bbox_top) ||
				tilemap_get_at_pixel(collision_map_id, bbox_left, targetY) ||
				tilemap_get_at_pixel(collision_map_id, bbox_right, targetY) ||
